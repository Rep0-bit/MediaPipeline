...
cloud) configurada como **Biblioteca Externa ("External Library")**, apontando **apenas** para
`organized/` — nunca para `photos/` (o despejo bruto, sem triagem).

Se a Biblioteca Externa ("External Library") do Immich apontar também para `photos/`, a triagem
